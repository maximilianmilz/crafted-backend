...
public class TicketTag extends TableImpl<TicketTagRecord> {
     ...
     */
    public final TableField<TicketTagRecord, Tag> TAG = createField(DSL.name("tag"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(de.crafted.api.service.common.jooq.enums.Tag.class), this, "");
