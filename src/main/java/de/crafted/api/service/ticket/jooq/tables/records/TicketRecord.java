...
public class TicketRecord extends UpdatableRecordImpl<TicketRecord> implements Record7<Long, String, String, Object, LocalDateTime, Long, Long> {
    ...
    @Override
    public Row7<Long, String, String, Object, LocalDateTime, Long, Long> valuesRow() {
    ...
    @Deprecated
    @Override
    public TicketRecord value4(Object value) {
        setStatus(value);
        return this;
    }
    ...
    @Override
    public TicketRecord values(Long value1, String value2, String value3, Object value4, LocalDateTime value5, Long value6, Long value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TicketRecord(Long id, String title, String description, Object status, LocalDateTime created, Long accountId, Long assignedTo) {
        super(Ticket.TICKET);
